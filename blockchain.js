        ...
        constructor(fromAddress, toAddress, amount){
         ...
         signTransaction(signingKey){
             if(signingKey.getPublic('hex') !== this.fromAddress){
                 throw new Erroe('You cannot sign transactions for other wallets...');
             }
...
class Blockchain{
          ...
          createGenesisBlock(){
              return new Block( "30/05/2022", "GenesisBlock", "0");
          }
          getLatestBlock(){
          ...
          addTransaction(transactions){
                ...
                if(!transactions.fromAddress || !transactions.toAddress){
                    throw new Error('Transaction must include from and to addresss..');
